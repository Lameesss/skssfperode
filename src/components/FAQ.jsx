...
const FAQS = [
  {
    ...
    answer:
      "Samastha Kerala Sunni Students Federation സമസ്ത കേരള ജംഇയ്യത്തുൽ ഉലമയുടെ വിദ്യാർത്ഥി വിഭാഗമാണ്. വിദ്യാർത്ഥികളുടെ മതപരവും ഭൗതികം വളർച്ച ലക്ഷ്യമാക്കി പ്രവർത്തിക്കുന്ന ഒരു സജീവ സംഘടനയാണ് ഇത്.",
  },
  {
